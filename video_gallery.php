        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white mt-0"><span style="color:#ffd400;">VIDEO</span> GALLERY</h2>
    ...
    <div id="portfolio">
        <div class="container notranslate">
            <div class="row g-0" style="margin-top: 2em;">
                <?php
                $result = $mysqli->query("SELECT * from res_category WHERE section = 'Video gallery'") or header("location:".$query_err_page);
                ?>
                ...
                ?>
                    ...
                    <div class="col-lg-4 col-sm-6 gal">
                        <a href="/videoCategory/<?php echo $category_name ?>">

                            <div class="card" style="width: 18rem; border:2px #fff solid; width:100%; background-color:#661414; border-radius:2em;">
                                <span class="center"><img class="card-img-top" src="/assests/images/play.png" alt="Card image cap"></span>
