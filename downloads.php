...
<head>
    ...
    <meta name="description" content="You can find the Zonal Downloads here. The Zonal Education Office, Katugastota is facilitating supervision, education, and management over 122 government schools within 5 divisions in the Katugastota zone, Sri Lanka. 5 branches Planning Branch, Development Branch, Finance Branch, Establishment Branch, Administration Branch">
    <meta name="keywords" content="Zonal Downloads, Downloads, resources, Katugastota Zonal Downloads">
    <meta name="robots" content="index, follow">

    <!-- Open graph data -->
    <meta name="og:title" property="og:title" content="Zonal Downloads : Zonal Education Office, Katugastota, Sri Lanka">
    <meta property="og:url" content="<?php echo $domain_name; ?>" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="You can find the Zonal Downloads here. The Zonal Education Office, Katugastota is facilitating supervision, education, and management over 122 government schools within 5 divisions in the Katugastota zone, Sri Lanka. The mission of the Zonal Education Office, Katugastota is to be Knowledgeable skilled individuals with the right attitudes to the globe. And the mission is to bestow a mother nation, a skilled, well-disciplined, humane student population and a satisfied teacher generation." />
    <meta property="og:image" content="<?php echo $domain_name; ?>includes/cardPhoto/card.webp" />

    <!-- Twitter Cards -->
    <meta name="twitter:title" content="Zonal Downloads : Zonal Education Office, Katugastota, Sri Lanka" />
    <meta name="twitter:card" content="You can find the Zonal Downloads here." />
...
<section class="page-section bg-primary" id="Academic_heading" style="max-height: 20em; padding-top:6em;">
    <nav aria-label="breadcrumb" style=" padding-left:2%; ">
        <ol class="breadcrumb" style="background-color: #ffd400; width: 11em; padding-left:1em; border-radius:0.5em;">
    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-8 text-center">
                <h2 class="text-white mt-0"><span style="color:#ffd400;">DOWNLOADS</span> SECTION</h2>
...
<div id="portfolio">
    <div class="container">
        <div class="row g-0" style="margin-top: 2em;">
            ...
            $result = $mysqli->query("SELECT * from res_category WHERE section = 'Downloads'") or header("location:".$query_err_page);
            ?>
            ...
            ?>
                ...
                <div class="col-lg-4 col-sm-6 gal">
                    <a href="/downloadsCategory/<?php echo $category_name ?>">

                        <div class="card" style="width: 18rem; border:2px #fff solid; width:100%; background-color:#661414; border-radius:2em;">
                            <span class="center"><img style="margin-top:20%" class="card-img-top" src="/assests/images/down.png" alt="Card image cap"></span>
