...
<head>
    ...
    <meta name="description" content="This is the notice category of <?php echo $category; ?>. The Zonal Education Office, Katugastota is facilitating supervision, education, and management over 122 government schools within 5 divisions in the Katugastota zone, Sri Lanka. 5 branches Planning Branch, Development Branch, Finance Branch, Establishment Branch, Administration Branch">
    <meta name="keywords" content="<?php echo $category; ?>, Zonal notices, notice category, zonal notice categories, notice category, Katugastota zonal notices">
    <meta name="robots" content="index, follow">

    <!-- Open graph data -->
    <meta name="og:title" property="og:title" content="<?php echo $category; ?> (Notices) - Zonal Education Office, Katugastota, Sri Lanka">
    <meta property="og:url" content="<?php echo $domain_name; ?>" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="You can find the zonal <?php echo $category; ?>  (Notices) here. The Zonal Education Office, Katugastota is facilitating supervision, education, and management over 122 government schools within 5 divisions in the Katugastota zone, Sri Lanka. The mission of the Zonal Education Office, Katugastota is to be Knowledgeable skilled individuals with the right attitudes to the globe. And the mission is to bestow a mother nation, a skilled, well-disciplined, humane student population and a satisfied teacher generation." />
    <meta property="og:image" content="<?php echo $domain_name; ?>includes/cardPhoto/card.webp" />

    <!-- Twitter Cards -->
    <meta name="twitter:title" content="<?php echo $category; ?> (Notice) - Zonal Education Office, Katugastota, Sri Lanka" />
    <meta name="twitter:card" content="You can find the zonal <?php echo $category; ?>  (Notices) here." />
    ...
    <title><?php echo $category; ?> (Zonal Notices)</title>
...
<!-- heading-->
    ...
    <section class="page-section bg-primary" id="Academic_heading" style="max-height: 17em; padding-top:6em;">
        <nav aria-label="breadcrumb" style=" padding-left:2%; ">
            <ol class="breadcrumb" style="background-color: #ffd400; width: 12em; padding-left:1em; border-radius:0.5em;">
                ...
                <li class="breadcrumb-item"><a href="/zonalNotices">Notices</a></li>
    ...
    $result = $mysqli->query("SELECT * from notices WHERE category = '$category'") or  header("location:".$query_err_page);
    ?>
    <br>
                    ...
                    <tr>
                        <td>
                            ...
                            <div style="width: 90vw;">
                                ...
                                <div class="collapse" id="col<?php echo $row['id']; ?>" class="collapse" data-parent="#accordion">
