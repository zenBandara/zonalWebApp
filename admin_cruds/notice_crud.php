<?php require_once ($_SERVER['DOCUMENT_ROOT'].'/process/notice_process.php'); ?>
<?php
    ...
    <script>
        function openModal() {
            $('#myModal').on('hidden.bs.modal', function() {
                ...
                window.location.assign('notice_crud.php');
            });
...
<body onload="openModal()">
    ...
    <div class="container">
        ...
        $result = $mysqli->query("SELECT * from notices") or die($mysqli->error);
        ?>
        <div class="breadtop" style="margin-bottom:5em;">
            <!-- Trigger the modal with a button -->
            <button type="button" style="margin: 2%;" class="btn btn-admin btn-xl" data-toggle="modal" data-target="#myModal">Add Notice</button>
            <button type="button" style="margin: 2%;" class="btn btn-admin btn-xl" data-toggle="modal" data-target="#catModal">Add Notice Category</button>
                                    ...
                                    <?php echo $row['content']; ?>
                                        ...
                                        <div style="text-align: right;">
                                            <li onclick="$('#myModal').modal('show')" style="display: inline;">
                                                <a href="notice_crud.php?edit=<?php echo $row['id'] ?>" class="btn btn-admin btn-xl" style="display: inline !important;">Edit</a>
                                            </li>


                                            <a href="/process/notice_process.php?delete=<?php echo $row['id'] ?>" class="btn btn-admin btn-xl" style="display: inline !important;" onclick="return confirm('Do you need to delete this item?')">Delete</a>
                                    </div>
                                </div>
                                </div>
                                    ...
                                    <?php else : ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="category" style="height:3%;" class="form-control" value="<?php echo $category; ?>" name="category" required>
                                                ...
                                                $result_role = $mysqli->query("SELECT * from notice_cat") or die($mysqli->error);
                                                ?>
                                        ...
                                        ?>
                                            <div class="form-group">
                                                <label>Add this notice to the event calender</label>
                                                <input type="checkbox" id="add_event" name="add_event" value="e">
                                            </div>
                                            <div id="grayChange" style="background-color:#c9c9c9; padding:2%;">
                                            <div class="row form-group" >
                                                <div class="col-md-6">
                                                    <label>Start date</label>
                                                    <input type="date" id="s_date" name="s_date" class="form-control" value="<?php echo $s_date; ?>" class="form-control" disabled required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label>Start Time</label>
                                                    <input type="time" id="s_time" name="s_time" class="form-control" value="<?php echo $s_time; ?>" class="form-control" disabled required>
                                                </div>
                                            </div>
                                            <div class="row form-group" >
                                                <div class="col-md-6">
                                                    <label>End date</label>
                                                    <input type="date" name="e_date" id="e_date" class="form-control" value="<?php echo $e_date; ?>" class="form-control" disabled required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label>End Time</label>
                                                    <input type="time" name="e_time" id="e_time" class="form-control" value="<?php echo $e_time; ?>" class="form-control" disabled required>
                                                </div>
                                            </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Add/Remove Notice category</h4>
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-center">
                            ...
                            <?php require_once 'noticecat_crud.php'; ?>
