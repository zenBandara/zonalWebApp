...
<?php
require_once ($_SERVER['DOCUMENT_ROOT'] .'/process/div_staff_process.php');
...
<head>
    ...
    <script>
        function openModal() {
            $('#myModal').on('hidden.bs.modal', function() {
                ...
                window.location.assign('div_staff_crud.php');
            });
    ...
    <title>Divisional Staff Add</title>
    <style>
        .center {
            display: block;
            margin-left: auto;
...
<body onload="openModal()">
    ...
    <div class="container">
        <?php
        $result = $mysqli->query("SELECT * from div_staff order by staff_id DESC") or die($mysqli->error);
        ?>
                    ...
                    while ($row = $result->fetch_assoc()) : ?>
                        <tr>
                            <td>
                                ...
                                <?php
                                $color_code = $row['div_head'] == 'no' ? 'background-color:#661414; color:#fff;' : 'background-color:#ffd400; color:#661414;';
                                echo $color_code;
                                ?>
                                 border-radius:3rem">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div style="text-align: left;">
                                                ...
                                                <?php endif; ?>
                                                <div style="<?php if ($row['div_head'] == 'no') {
                                                                echo 'color:#c2c2c2';
                                                            } ?>">
                                                    <?php if ($row['div_head'] != 'no') { ?>
                                                        <h5><strong>Head of Divisional Education Office - </strong><?php echo $row['div_head']; ?></h5>
                                                    <?php } else { ?>
                                                        <h5><strong>Divison - </strong><?php echo $row['division']; ?></h5>
                                                    <?php } ?>
                                                ...
                                                <div style="text-align: right; margin-bottom:1em;">
                                                    <li onclick="$('#myModal').modal('show')" style="display: inline !important;">
                                                        <a href="div_staff_crud.php?edit=<?php echo $row['staff_id'] ?>" class="btn btn-light btn-xl" style="display: inline !important;">Edit</a>
                                                    </li>
                                                    <li style="display: inline !important;">
                                                        <a href="/process/div_staff_process.php?delete=<?php echo $row['staff_id'] ?>" class="btn btn-light btn-xl" style="display: inline !important;" onclick="return confirm('Do you need to delete this item?')">Delete</a>
                                                    </li>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        if ($update == true) :
                        ?>
                            <h4 class="modal-title">Edit Divisional Staff Member</h4>

                        <?php else : ?>
                            <h4 class="modal-title">Add Divisional Staff Member</h4>
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-center">
                            <form action="/process/div_staff_process.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Add person as a head of the divional education office </label>
                                    <input type="checkbox" id="as_head" name="as_head_arr[]" value="t" <?php if ($as_head == '1') {
                                                                                                            echo ' checked';
                                                                                                        }  ?>>
                                </div>

                                <div class="form-group" id="grayChange">
                                    <label>Choose head type of Division</label>
                                    <select id="div_head" style="height:3%;" class="form-control" value="<?php echo $div_head; ?>" name="div_head" required <?php if ($as_head != '1') {
                                        ...
                                        <?php
                                        $result_poojapitiya = $mysqli->query("SELECT * from div_staff WHERE div_head = 'poojapitiya'") or die($mysqli->error);

                                        if ($result_poojapitiya->num_rows == 0 || $update == true) {
                                        ?>

                                            <option value="poojapitiya" <?php if ($div_head == 'poojapitiya') {
                                                                            echo 'selected';
                                                                        }  ?>>Head of Poojapitiya Educational Division</option>

                                        <?php }
                                        ?>

                                        <?php
                                        $result_galagedara = $mysqli->query("SELECT * from div_staff WHERE div_head = 'galagedara'") or die($mysqli->error);

                                        if ($result_galagedara->num_rows == 0 || $update == true) {
                                        ?>
                                            <option value="galagedara" <?php if ($div_head == 'galagedara') {
                                                                            echo 'selected';
                                                                        }  ?>>Head of Galagedara Educational Division</option>
                                        <?php }
                                        ?>

                                        <?php
                                        $result_akurana = $mysqli->query("SELECT * from div_staff WHERE div_head = 'akurana'") or die($mysqli->error);

                                        if ($result_akurana->num_rows == 0 || $update == true) {
                                        ?>
                                            <option value="akurana" <?php if ($div_head == 'akurana') {
                                                                        echo 'selected';
                                                                    }  ?>>Head of Akurana Educational Division</option>

                                        <?php }
                                        ?>
                                        <?php
                                        $result_hatharaliyadda = $mysqli->query("SELECT * from div_staff WHERE div_head = 'hatharaliyadda'") or die($mysqli->error);

                                        if ($result_hatharaliyadda->num_rows == 0 || $update == true) {
                                        ?>
                                            <option value="hatharaliyadda" <?php if ($div_head == 'hatharaliyadda') {
                                                                                echo 'selected';
                                                                            }  ?>>Head of Hatharaliyadda Educational Division</option>
                                        <?php }
                                        ?>

                                        <?php
                                        $result_harispaththuwa = $mysqli->query("SELECT * from div_staff WHERE div_head = 'harispaththuwa'") or die($mysqli->error);



                                        if ($result_harispaththuwa->num_rows == 0 || $update == true) {
                                        ?>
                                            <option value="harispaththuwa" <?php if ($div_head == 'harispaththuwa') {
                                                                                echo 'selected';
                                                                            }  ?>>Head of Harispaththuwa Educational Division</option>
                                        <?php }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="division" style="height:3%;" class="form-control" value="<?php echo $division; ?>" name="division" required <?php if ($as_head == '1') {

                                                                                                                                                                echo 'disabled';
                                                                                                                                                            } ?>>
                                        <option value="">~~NOT SELECTED~~</option>
                                        <option value="poojapitiya" <?php if ($division == 'poojapitiya') {
                                                                        echo 'selected';
                                                                    }  ?>>Poojapitiya Division</option>
                                        <option value="galagedara" <?php if ($division == 'galagedara') {
                                                                        echo 'selected';
                                                                    }  ?>>Galagedara Division</option>
                                        <option value="akurana" <?php if ($division == 'akurana') {
                                                                    echo 'selected';
                                                                }  ?>>Akurana Division</option>
                                        <option value="hatharaliyadda" <?php if ($division == 'hatharaliyadda') {
                                                                            echo 'selected';
                                                                        }  ?>>Hatharaliyadda Division</option>
                                        <option value="harispaththuwa" <?php if ($division == 'harispaththuwa') {
                                                                            echo 'selected';
                                                                        }  ?>>Harispaththuwa Division</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="acstaff_grade" style="height:3%;" class="form-control" value="<?php echo $acstaff_grade; ?>" name="acstaff_grade" required>
                                        ...
                                        $result_grade = $mysqli->query("SELECT * from grade WHERE category = 'Divisional' or category = 'All' ") or die($mysqli->error);
                                        ?>
                                ...
                                ?>
                                    ...
                                    <?php else : ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="acstaff_role" style="height:3%;" class="form-control" value="<?php echo $acstaff_role; ?>" name="acstaff_role" required <?php if ($as_head == '1') {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="acstaff_subject" style="height:3%;" class="form-control" value="<?php echo $acstaff_subject; ?>" name="acstaff_subject" required <?php if ($as_head == '1') {
                                    ...
                                    <script>
                                        $(function() {
                                            $('#as_head').change(function() {
                                                if (this.checked) {
                                                    $('#div_head').prop('disabled', false);
                                                    //$('#branch').css('display', 'none');
                                                    $('#division').prop('disabled', true);
                                                    $('#acstaff_role').prop('disabled', true);
                                                    $('#acstaff_subject').prop('disabled', true);

                                                } else {
                                                    $('#div_head').prop('disabled', true);
                                                    $('#division').prop('disabled', false);
                                                    $('#acstaff_role').prop('disabled', false);
                                                    $('#acstaff_subject').prop('disabled', false);
                                                }
                                            });
                                        });
                                    </script>
