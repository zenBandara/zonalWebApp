    ...
    require_once ($_SERVER['DOCUMENT_ROOT'].'/process/vacancycat_process.php'); 
    ...
    <div class="container">
        <?php
        $result = $mysqli->query("SELECT * from vacancy_cat") or die($mysqli->error);
                    ...
                    while ($row = $result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td style="text-align: center; width: 10%; padding:0.8em;">
                                ...
                                <a href="/process/vacancy_process.php?delete_cat=<?php echo $row['id'] ?>" class="btn btn-admin btn-xl" style="display: inline !important;" onclick="return confirm('Do you need to delete this item?')">Delete</a>
