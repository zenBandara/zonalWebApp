    ...
    <script>
        function openModal() {
            $('#myModal').on('hidden.bs.modal', function() {
                ...
                window.location.assign('grade_crud.php');
            });
...
<body onload="openModal()">
    ...
    <?php require_once ($_SERVER['DOCUMENT_ROOT'].'/process/grade_process.php');
    ...
    <div class="container">
        <?php
        $result = $mysqli->query("SELECT * from grade ORDER BY id DESC") or die($mysqli->error);
        //pre_r($result);
        ...
        <div class="breadtop" style="margin-bottom:5em;">
            ...
            <button type="button" style="margin: 2%;" class="btn btn-admin btn-xl" data-toggle="modal" data-target="#myModal">Add Grade</button>
                    ...
                    while ($row = $result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td style="text-align: center; width: 10%; padding:1em;">
                                ...
                                <a href="/process/grade_process.php?delete=<?php echo $row['id'] ?>" class="btn btn-admin btn-xl" style="display: inline !important;" onclick="return confirm('Do you need to delete this subject?')">Delete</a>
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-center">
                            <form action="/process/grade_process.php" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="grade_id" class="form-control"  placeholder="ID" class="form-control" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="grade_name" class="form-control"  placeholder="Enter the Grade" class="form-control" required>
                                </div>

                                <div class="form-group">
                                    <label>Grade category</label>
                                    <select id="subject_cat" style="height:3%;" class="form-control"  name="grade_cat" required>
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-light btn-xl" onclick="window.location.assign('grade_crud.php');">Close</a>
                        </div>
