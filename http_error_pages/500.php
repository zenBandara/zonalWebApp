...
<head>
    ...
    <title>Katu Zonal | Internal Server Issue!
    </title>
    <style>
...
<body>
    ...
    <div class="context">
        <h1>500 - Internal Server Issue! We are temporarily unavailable! Try again later!</h1>
        <div class="container" style="text-align: center;">
            <h3 style="color: #ffd400;">Zonal Education Office, Katugastota, Sri Lanka</h3>
            <br>
            <a class="btn btn-light btn-xl" href="/home" >Go to the home page</a>
        </div>
